...
Mendukung pelacakan lengkap: Jobs, Contents, Provenance, QC, Publications, Metrics, Cost, Audit.
"""
...
class Publication(Base):
    ...
    id = Column(String(36), primary_key=True, default=generate_uuid)
    content_id = Column(String(36), ForeignKey("contents.id"), nullable=False, index=True)
    platform = Column(String(50), nullable=False)  # instagram, tiktok, youtube_shorts, mock
...
class CostRecord(Base):
    ...
    service = Column(String(50), nullable=False)  # gemini_text, veo_video, imagen_image
